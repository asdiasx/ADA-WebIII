package com.example.apostasapi.client;

import com.example.apostasapi.client.dto.SorteioDTO;
...
@Component
public class SorteiosClient {

    private static final String CATALOGO_URI = "/api/v1/sorteios/";

    private final WebClient client;

    public SorteiosClient(WebClient.Builder clientBuilder) {
